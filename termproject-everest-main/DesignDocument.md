...
- [Design Document](#design-document)
  - [TA Management](#-your-project-title)
  - [* `yes`,`<organization>`](#-author1organization)
 ...
 * Discuss the rationale for the proposed decomposition in terms of cohesion, coupling, and re-use.
...
(***in iteration-1***) Include a list of the tables (models) in your database and explain the role of each table. Provide the attributes of the tables. 
Iteration 1:

User: The user have options to choose the login between Faculty and Student. The faculty and student login database is designed to use the user class model. The user class contains numerous string and integer types such as for username, password to let the user login. Once the user is logged in the task will be assigned based on the student or faculty. 

Faculty: Faculty class lets the faculty members to login. 

Student: Student class lets the students to  login.
